...
El agente genera: casos Gherkin, matriz de riesgos, pruebas de integración con **Serenity BDD** y colecciones de **Postman v9.13.2**.
...
| `@QA Agent` | Fase 4 | Gherkin, riesgos, Serenity BDD y Postman |
...
| `/postman-collection-generator` | QA Agent | Genera colecciones de Postman v9.13.2 para validación de contratos |
| `/automation-flow-proposer` | QA Agent | Propone flujos a automatizar con Serenity BDD |
